...
class ReservationView(View):
    ...
    def get(self, request, date=date):
        ...
        return render(request, 'reservation/list.html', {'form': self.f, 'reservs': reservs, 'seats': self.seats, 'current_date': self.current_date, 'coming_days': self.coming_days, 'logs': logs, 'MAX_HOUR': settings.MAX_HOUR, 'MIN_STEPS': settings.MIN_STEPS, 'MAX_RES_TIME': settings.MAX_RES_TIME, 'DEF_RES_TIME': settings.DEF_RES_TIME})

    def post(self, request, date=date):
